...
export class ChartComponent implements OnInit {
  ...
  constructor() { }
  @ViewChild('chart') private chartContainer: ElementRef; // reference to DOM element
  ...
  private createChart(): void {
    ...
    /* constructing and positioning svg element */
    this.svg = d3
      .select(element)
      .append('svg')
    ...
    this.arc = d3
      .arc()
      .startAngle((d: any) => { console.log(d.y0);
